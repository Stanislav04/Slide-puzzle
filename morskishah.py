...
lblPlayerX = Label(RightFrame1, font=("black", 40, "bold"), text="Igrach X:", padx=2, pady=2, bg="olivedrab")
...
lblPlayerO = Label(RightFrame1, font=("black", 40, "bold"), text = "Igrach O: ", padx = 2, pady = 2, bg = "olivedrab")
